...
import {AiwbApplicationSchema} from "./schemas/aiwb/application.ts";
...
const StarlightFrontmatterSchema = (context: SchemaContext) =>
	z.object({
		...
		/** aiwb: 是否显示标题*/
		isShowTitle: z.boolean().default(true),
		...
		*  unDefined unDefPtr（
		* */
		aiwbPageType: z.enum(["aiwbApplication","aiwbReview","unDefined"]).default("unDefined"),

		aiwbApplication: AiwbApplicationSchema(context).optional(),
